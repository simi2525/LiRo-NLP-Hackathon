...
if __name__ == '__main__':
    ...
    model = DiacCanineBertTokenClassification.load_from_checkpoint('checkpoints1/epoch=0-step=23437.ckpt', strict=True, num_labels=len(utils.labels), per_label_weights=per_label_weights, lr=LR)
    ...
    trainer.fit(model, train_dataloader, test_dataloader, ckpt_path='checkpoints1/epoch=0-step=23437.ckpt')