...
if __name__ == '__main__':
    ...
    per_label_counts = [x*100 for x in per_label_counts]
    ...
    checkpoint_callback_hours = ModelCheckpoint(dirpath="checkpoints_canine_bert_4hours",every_n_train_steps=None,every_n_epochs=None, train_time_interval=timedelta(hours=4), save_top_k=3, monitor="step")
